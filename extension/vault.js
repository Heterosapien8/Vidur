...
(function (root) {
  ...
  // Expose on root (window / self / globalThis)
  root.VidurVault = VidurVault;
  root.isVaultConfigured = isVaultConfigured;
  root.isVaultUnlocked = isVaultUnlocked;
  root.getDecryptedProfile = getDecryptedProfile;
  root.lockVault = lockVault;
  root.setupVault = setupVault;
  root.unlockVault = unlockVault;
  root.updateVaultProfile = updateVaultProfile;

  if (typeof module !== 'undefined' && module.exports) {
    module.exports = VidurVault;
  }
